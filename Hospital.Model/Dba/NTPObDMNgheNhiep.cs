...
{
    public class NTPObDMNgheNghiep
    {
            public static bool TestExistPK(string K_Ma)
            {
                SqlCommand sqlCommand = new SqlCommand();
                sqlCommand.CommandText = "SELECT Ma FROM tb_DMNgheNghiep WHERE(Ma = @K_Ma)";
            ...
            public static ObDMNgheNghiep GetObWF_PK(string K_Ma)
            {
                SqlCommand sqlCommand = new SqlCommand();
                sqlCommand.CommandText = "SELECT * FROM tb_DMNgheNghiep WHERE(Ma = @K_Ma)";
                SqlParameter sqlParameter = new SqlParameter();
                sqlParameter.ParameterName = "K_Ma";
                sqlParameter.SqlDbType = SqlDbType.NVarChar;
                sqlParameter.Value = K_Ma;
                ...
                {
                    ObDMNgheNghiep ObICD = null;
                    while (sqlDataReader.Read())
                    {
                        ObICD = new ObDMNgheNghiep();
                        ...
                        if (!sqlDataReader.IsDBNull(3))
                        {
                            ...
                            if (array.Length > 1)
                            {
                                try
                                {
                                    ...
                                    ObICD.TTChung = (Cls_TTDMNgheNghiep)binaryFormatter.Deserialize(serializationStream);
                                }
                                catch
                                {
                                    ObICD.TTChung = new Cls_TTDMNgheNghiep();
                                }
                            }
                            else
                            {
            ...
            public static int Insert(ObDMNgheNghiep ob)
            {
                SqlCommand sqlCommand = new SqlCommand();
                sqlCommand.CommandText = " INSERT INTO tb_DMNgheNghiep (Ma, Ten,Loai,TTChung) VALUES(@Ma, @Ten,@Loai,@TTChung)";
            ...
            public static int Update(string ma, ObDMNgheNghiep ob)
            {
                SqlCommand sqlCommand = new SqlCommand();
                sqlCommand.CommandText = " UPDATE tb_DMNgheNghiep SET Ma=@Ma,Ten=@Ten,Loai=@Loai,TTChung=@TTChung WHERE (Ma=@MaBNDK)";
            ...
            public static int Delete(ObDMNgheNghiep ob)
            {
                SqlCommand sqlcommand = new SqlCommand();
                sqlcommand.CommandText = "DELETE FROM tb_DMNgheNghiep WHERE(Ma=@Ma)";
                SqlParameter sqlparameter = new SqlParameter(); sqlparameter.ParameterName = "Ma"; sqlparameter.SqlDbType = SqlDbType.NVarChar;
                sqlparameter.Size = 100; sqlparameter.Value = ob.Ma; sqlcommand.Parameters.Add(sqlparameter);
                return DBStatic.SqlExcuteNonQuery(sqlcommand);
            }
            public static KeysListObDMNgheNghiep GetListOb()
            {
                SqlCommand sqlCommand = new SqlCommand();
                sqlCommand.CommandText = "SELECT * FROM tb_DMNgheNghiep";
                SqlDataReader sqlDataReader = DBStatic.SqlExcuteQuery(sqlCommand);
                KeysListObDMNgheNghiep list = new KeysListObDMNgheNghiep();
                if (null == sqlDataReader)
                {
                    list = null;
                }
                ...
                {
                    ObDMNgheNghiep Obtb_Customer = null;
                    while (sqlDataReader.Read())
                    {
                        Obtb_Customer = new ObDMNgheNghiep();
                        if (!sqlDataReader.IsDBNull(0))
                        {
                        ...
                        if (!sqlDataReader.IsDBNull(3))
                        {
                            ...
                            if (array.Length > 1)
                            {
                                try
                                {
                                    BinaryFormatter binaryFormatter = new BinaryFormatter();
                                    MemoryStream serializationStream = new MemoryStream(array);
                                    Obtb_Customer.TTChung = (Cls_TTDMNgheNghiep)binaryFormatter.Deserialize(serializationStream);
                                }
                                catch
                                {
                                    Obtb_Customer.TTChung = new Cls_TTDMNgheNghiep();
                                }
                            }
                            else
                            {
