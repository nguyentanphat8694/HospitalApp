...
namespace Hospital.App
{
	...
	public class WebCamCapture : System.Windows.Forms.UserControl
	{
		...
		*/
        ...
        public int _VIDEOSOURCEINDEX = 0;
        private FilterInfoCollection videoCaptureDevie;
        string Device = "WebCap";
		public void Start(ulong FrameNum)
		{
			try
			{
                //videoCaptureDevie = new FilterInfoCollection(FilterCategory.VideoInputDevice);
                //Device = videoCaptureDevie[0].Name;
                //main_QLyPhongkham.WriteLogFile("WebCam divice: " + Device);
                //if (Device == "")
                //{
                //    Device="WebCap";
                //}
				...
				mCapHwnd = capCreateCaptureWindowA(Device, 0, 0, 0, m_Width, m_Height, this.Handle.ToInt32(), 0);
                
				// connect to the capture device
				Application.DoEvents();
                SendMessage(mCapHwnd, WM_CAP_CONNECT, _VIDEOSOURCEINDEX, 0);
                //SendMessage(mCapHwnd, WM_CAP_SET_VIDEOFORMAT, 0, 0);
        ...
        public void SendMessage(uint WM_CAP_Type)
        {
            Stop();
            SendMessage(mCapHwnd, WM_CAP_CONNECT, 0, 0);
            SendMessage(mCapHwnd, WM_CAP_Type, 0, 0);
